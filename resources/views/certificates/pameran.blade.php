...
<head>
    ...
    <style>
        body { font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; text-align: center; color: #333; margin: 0; padding: 0; background-color: #EBF5FB; }
        .container { width: 100%; max-width: 800px; margin: 0 auto; padding: 50px; border: 15px solid #3498DB; background-color: #ffffff; box-sizing: border-box; }
        .header { font-size: 38px; font-weight: bold; margin-bottom: 20px; color: #2980B9; letter-spacing: 2px; }
        .sub-header { font-size: 18px; margin-bottom: 40px; color: #7f8c8d; }
        .name { font-size: 45px; font-weight: bold; margin-bottom: 30px; color: #2C3E50; text-transform: uppercase; border-bottom: 2px solid #3498DB; display: inline-block; padding-bottom: 10px; }
        .event-info { font-size: 18px; margin-bottom: 40px; line-height: 1.6; }
        .theme { font-weight: bold; color: #3498DB; }
...
<body>
    <div class="container">
        ...
        <div class="sub-header">Diberikan Kepada:</div>
        <div class="name">{{ $user->nama }}</div>
        <div class="event-info">
            Atas kehadiran dan dukungannya dalam acara <span class="theme">PAMERAN</span> eksklusif:<br><br>
